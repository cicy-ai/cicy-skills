...
```sh
cicy-policy patch '{"preventive":{"enabled":true}}'
```
...
```sh
cicy-policy set fail_mode closed
cicy-policy set preventive.enabled true
```
...
```sh
cicy-policy unset preventive.enabled
```
...
cicy-policy recent --agent w-10001
```
