...
用法（用当前 CICY_ENGINE_DIR 的 Python 环境调用）:
...
详细生成日志同时写到 stderr 和 CICY_ENGINE_DIR/last_tts.log。
"""
import argparse
import os
import sys
...
ENGINE_DIR = os.environ.get("CICY_ENGINE_DIR", os.path.expanduser("~/cicy-ai/models/cosyvoice"))
REPO = os.path.join(ENGINE_DIR, "CosyVoice")
sys.path.append(REPO)
sys.path.append(REPO + "/third_party/Matcha-TTS")

LOG_PATH = os.path.join(ENGINE_DIR, "last_tts.log")
_logf = None
