---
name: cicy-knowledge
description: Team knowledge Layer 2 store CLI over cicy-code's /api/knowledge: add/list/get/recall/promote/reject/supersede. Recall is keyword+tag over canon (no vector RAG).
---
